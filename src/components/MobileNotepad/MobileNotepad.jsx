...
const NP_PAGES = [
  ...
  { id: 'struggles',   type: 'content',
    title: 'Stronger Us', titleColor: 'red',
    image: { src: 'pic12.JPG', alt: 'Group study', caption: '10% study, 90% panic' },
    quote: '"Ten years from now, you wont remember the grade you got in a semester, but you will remember the night you and your friends stayed up talking about absolutely nothing."',
  },
  { id: 'lateNights',  type: 'content',
    title: 'The Hostel Chaos',
    image: { src: '/pic10.jpg', alt: 'Late night food', caption: '10% study, 90% panic' },
